...
UvjetnoPridruživanje
---------------------
Primjer naredbe uvjetnog pridruživanja ?:


GrananjeSwitch
--------------
Primjer grananja switch.
...
--------------------
Primjer korištenja naredbi continue (vraćanje na početak petlje) i break (iskakanje iz petlje).
...
MetodeProširenja
----------------
U mnogim slučajevima kada se trebaju obraditi podaci u nizovima i kolekcijama, umjesto pisanja vlastitih petlji
jednostavnije je upotrijebiti metode proširenja sučelja IEnumerable<T> (vidi
https://msdn.microsoft.com/en-us/library/ckzcawb8(v=vs.110).aspx#Extension%20Methods)
